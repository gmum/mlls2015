...
def _get_job_opts(jaccard, fold, strategy, batch_size):
    ...
    opts['output_dir'] = path.join(RESULTS_DIR, "SVM-uncertainty")
    return opts
...
if __name__ == "__main__":
    ...
    run_async_with_reporting(run_job, jobs, n_jobs=opts.n_jobs, output_dir=path.join(RESULTS_DIR, "SVM-uncertainty"))