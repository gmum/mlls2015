...
class TestDataAPI(unittest.TestCase):
    ...
    def test_composite_experiment(self):
        ...
        run_experiment("random_query", loader_args={"n_folds":2}, batch_size=10, seed=655)
        results = run_experiment("random_query", loader_args={"n_folds":2},  batch_size=20, seed=655)
    ...
    def test_grid_params_setting(self):
        ...
        turn_on_force_reload_all()
        results = run_experiment_grid(name="random_query", loader_args={"n_folds":2},  n_jobs=4, \
        ...
        turn_off_force_reload_all()
        results = run_experiment_grid(name="random_query", n_jobs=4, loader_args={"n_folds":2}, \
